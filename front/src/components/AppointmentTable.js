...
import { deleteAppointment, postAppointmentDoctor, updateAppointment } from '../axios/controllers';
import Select from "react-select";

function TabelProgramari({ programari, fisaMed, id }) {
  const dates = [
      ...
      <MaterialTable
        ...
        editable={{
          ...
          onRowUpdate: (updatedRow, oldRow) => new Promise((resolve, reject) => {
            try {
              console.log(oldRow);
              updateAppointment(appointmentsRoute, { date: updatedRow.date, symptoms: updatedRow.symptoms, other_information: updatedRow.other_information, doctorId: updatedRow.doctorId }, oldRow.appointmentId);
            }
            catch (err) {
              console.log(err);
            }
